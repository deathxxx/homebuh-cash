...
class DbUpdate {
	...
	public function updateData( $file_ver, $db_ver ) {
		...
		if ( $file_ver >= 1.05 && $db_ver < 1.05 ) {
			$this->updateData_v1_050();
		}
		if ( $file_ver >= 1.055 && $db_ver < 1.055 ) {
			$this->updateData_v1_055();
		}
		if ( $file_ver >= 1.061 && $db_ver < 1.061 ) {
			$this->updateData_v1_061();
		}
		if ( $file_ver >= 1.081 && $db_ver < 1.081 ) {
			$this->updateData_v1_081();
		}
